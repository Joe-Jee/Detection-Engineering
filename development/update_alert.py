...
url = "https://d94a02b08d60452b9128f6ccef075062.us-central1.gcp.cloud.es.io:9243/api/detection_engine/rules"
...
for root, dirs, files in os.walk("E:\\DEB\\TOML lab\\converted_detections"):
    for file in files:
        data = "{\n"
